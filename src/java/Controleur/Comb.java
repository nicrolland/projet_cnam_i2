 ...
 * @author nicolas
 */
@WebServlet(name = "Comb", urlPatterns = {"/comb"})
public class Comb extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Comb</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1> GET Servlet Comb at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        /* TODO output your page here. You may use following sample code. */
        out.println("GET request denied");
    }
